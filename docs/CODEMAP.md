...
| 3i | ColocRequest, LDHeatmapRequest | One frozen request per family, built by the plotter and consumed by `render_coloc` and `render_ld_heatmap` | [_coloc_renderer.py](../src/pylocuszoom/_coloc_renderer.py), [_ld_heatmap_renderer.py](../src/pylocuszoom/_ld_heatmap_renderer.py) |
...
| 3i | Semantic family renderers | Panel composition and backend-neutral figure intent | [_stats_renderer.py](../src/pylocuszoom/_stats_renderer.py), [_coloc_renderer.py](../src/pylocuszoom/_coloc_renderer.py), [_ld_heatmap_renderer.py](../src/pylocuszoom/_ld_heatmap_renderer.py) |

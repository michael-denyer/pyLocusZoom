...
| 3i | Semantic family renderers | Panel composition and backend-neutral figure intent | [_coloc_renderer.py](../src/pylocuszoom/_coloc_renderer.py), [_ld_heatmap_renderer.py](../src/pylocuszoom/_ld_heatmap_renderer.py) |
